...
from core.backup import backup_income, backup_expense, backup_summary, backup_all_summaries
...
class MainWindow:
    def __init__(self, root, app_state):
        ...
        # ================== WINDOW ==================
        self.root.title("NonVAT Tax Tool")
        ...
        self.title_label = ctk.CTkLabel(
            self.header_left,
            text="Tax Computation & Filing Assistant",
    ...
    def build_menu(self):
        ...
        help_menu.add_command(label="Tax Filing Guide", command=self.open_help)
    ...
    def build_income_tab(self):
        ...
        self.income_year_var.trace_add("write", lambda *args: self.load_income_table() if hasattr(self, "income_table") else None)
        ...
        self.income_quarter_var.trace_add("write", lambda *args: self.load_income_table() if hasattr(self, "income_table") else None)
        ...
        columns = ("date", "gross_income", "client/customer", "ref._no.", "description", "cwt", "atc", "income_received")
    ...
    def build_expense_tab(self):
        ...
        columns = ("date", "gross_expense", "business_name", "ref._no.", "description", "wt", "atc", "expense_paid")
    ...
    def add_income(self):
        def on_save(new_id):
            ...
            backup_all_summaries(self.storage, self.app_state)
