...
class ExpenseForm(tk.Toplevel):
    def __init__(self, parent, storage: StorageManager, row_data=None, refresh_callback=None):
        ...
        self.customer_var = tk.StringVar(value=row_data.get("business_name") if row_data else "")
        ctk.CTkEntry(
            self.scrollable_container,
            textvariable=self.customer_var,
            fg_color="#1f2a38",
            text_color="white",
            placeholder_text="Enter Vendor/Business Name",
            corner_radius=8,
            border_width=2,
            border_color="#365580",
            height=25
    ...
    def save_expense(self):
        ...
        business_name = self.customer_var.get().strip()
