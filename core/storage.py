...
class StorageManager:
    ...
    def add_income(self, data: dict):
        self.cursor.execute("""
            INSERT INTO income (
                date, gross_income, client_name, ref_num, description, cwt, atc, income_received, created_at
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        """, (
            data["date"],
            data["gross_income"],
    ...
    def update_income(self, record_id, data: dict):
        self.cursor.execute("""
            UPDATE income
            SET date = ?, gross_income = ?, client_name = ?, ref_num = ?, description = ?, cwt = ?, atc = ?, income_received = ?
            WHERE id = ?
        """, (
            data["date"],
            data["gross_income"],
    ...
    def add_expense(self, data: dict):
        self.cursor.execute("""
            INSERT INTO expense (
                date, gross_expense, business_name, ref_num, description, wt, atc, expense_paid, created_at
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        """, (
            data["date"],
            data["gross_expense"],
    ...
    def update_expense(self, record_id, data: dict):
        self.cursor.execute("""
            UPDATE expense
            SET date = ?, gross_expense = ?, business_name = ?, ref_num = ?, description = ?, wt = ?, atc = ?, expense_paid = ?
            WHERE id = ?
        """, (
            data["date"],
            data["gross_expense"],
